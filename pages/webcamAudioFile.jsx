        ...
        const startStream = async () => {
            ...
            if (useSampleAudio) {
                ...
                if (data) {
                    ...
                    const stream = (typeof audioEl.captureStream === 'function' ? audioEl.captureStream() : null) ||
    ...
    return (<div className="flex flex-col items-center justify-center min-h-screen">
            ...
            <div className="mt-4">
                <label className="flex items-center space-x-2">
                    <input type="checkbox" checked={useSampleAudio} onChange={(e) => setUseSampleAudio(e.target.checked)}/>
